...
```python
!jupyter nbconvert --to markdown Users/JoelGohTzeWen/OneDrive - Think city/GEOG0051_github/test.ipynb
...
```
    ...
    [NbConvertApp] WARNING | pattern 'Users/JoelGohTzeWen/OneDrive' matched no files
    [NbConvertApp] WARNING | pattern '-' matched no files
    [NbConvertApp] WARNING | pattern 'Think' matched no files
    [NbConvertApp] WARNING | pattern 'city/GEOG0051_github/test.ipynb' matched no files
    


```python
!jupyter nbconvert --to markdown Users/JoelGohTzeWen/GEOG0051_github/test.ipynb
```
    ...
    [NbConvertApp] WARNING | pattern 'Users/JoelGohTzeWen/GEOG0051_github/test.ipynb' matched no files
    


```python
!jupyter nbconvert --to markdown /Users/JoelGohTzeWen/OneDrive - Think city/Attachments/Desktop/GEOG0051_github/test.ipynb
...
```
    ...
    [NbConvertApp] WARNING | pattern '-' matched no files
    [NbConvertApp] WARNING | pattern 'Think' matched no files
    [NbConvertApp] WARNING | pattern 'city/Attachments/Desktop/GEOG0051_github/test.ipynb' matched no files
    [NbConvertApp] Converting notebook /Users/JoelGohTzeWen/OneDrive to markdown
    Traceback (most recent call last):
      File "<frozen runpy>", line 198, in _run_module_as_main
      File "<frozen runpy>", line 88, in _run_code
      File "C:\ProgramData\anaconda3\envs\envGEOG0051\Scripts\jupyter-nbconvert.EXE\__main__.py", line 7, in <module>
      File "C:\ProgramData\anaconda3\envs\envGEOG0051\Lib\site-packages\jupyter_core\application.py", line 283, in launch_instance
        super().launch_instance(argv=argv, **kwargs)
      File "C:\ProgramData\anaconda3\envs\envGEOG0051\Lib\site-packages\traitlets\config\application.py", line 1075, in launch_instance
        app.start()
      File "C:\ProgramData\anaconda3\envs\envGEOG0051\Lib\site-packages\nbconvert\nbconvertapp.py", line 420, in start
      ...
      File "C:\ProgramData\anaconda3\envs\envGEOG0051\Lib\site-packages\nbconvert\exporters\templateexporter.py", line 386, in from_filename
        return super().from_filename(filename, resources, **kw)  # type:ignore[return-value]
               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "C:\ProgramData\anaconda3\envs\envGEOG0051\Lib\site-packages\nbconvert\exporters\exporter.py", line 200, in from_filename
        with open(filename, encoding="utf-8") as f:
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    PermissionError: [Errno 13] Permission denied: '/Users/JoelGohTzeWen/OneDrive'
